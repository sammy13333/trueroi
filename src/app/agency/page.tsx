  ...
  return (
    <AppShell>
      <PageHeader
        ...
        actions={<Link href="/agency/settings" className="rounded-md bg-[#d4af37] px-3.5 py-2 text-xs font-semibold text-black">Connect data sources</Link>}
      />
      <FilterBar />
      <div className="p-5 sm:p-8">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1.45fr_1fr]">
          <section className="rounded-lg border border-[#272722] bg-[#0c0c0b] p-5">
            <div className="flex items-center justify-between"><div><h2 className="text-sm font-medium text-zinc-200">Acquisition funnel</h2><p className="mt-1 text-xs text-zinc-600">Leads → booked → showed → sold</p></div><Link href="/agency/leads" className="text-xs text-[#d4af37]">View lead tracking</Link></div>
            ...
            <p className="mt-9 rounded-md border border-dashed border-[#302f2a] px-3 py-2.5 text-xs text-zinc-600">Connect GHL to identify where the funnel is breaking. “Showed” is calculated as booked without a no-show outcome.</p>
          </section>
          <section className="rounded-lg border border-[#272722] bg-[#0c0c0b] p-5">
            ...
            <Link href="/agency/settings" className="mt-8 block rounded-md border border-[#302f2a] px-3 py-2 text-center text-xs text-zinc-400">Open sync settings</Link>
          </section>
        </div>
      </div>
    </AppShell>
