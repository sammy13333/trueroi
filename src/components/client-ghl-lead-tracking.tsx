  ...
  return <div className="m-5 space-y-5 sm:m-8">
    ...
    <section className="overflow-hidden rounded-lg border border-[#272722] bg-[#0c0c0b]">
      <div className="border-b border-[#272722] px-4 py-3">
        ...
        <p className="mt-0.5 text-xs text-zinc-600">CRM leads require the contact tag “new lead”; booked appointments require “booked appointment” or “appointment booked”. Meta delivery action counts are separate.</p>
      </div>
